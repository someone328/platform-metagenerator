...
public class GitCloneWrapper {
   ...
   public static void cloneUrl(String url){
      try {
         ...
         removeFolderIfAlreadyCloned(url);
   ...
   private static void removeFolderIfAlreadyCloned(String url) throws Exception {
      String folderForClone = calculateFolderNameFrom(url);
      Path path = Paths.get(folderForClone);
